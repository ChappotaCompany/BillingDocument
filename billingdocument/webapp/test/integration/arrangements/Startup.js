sap.ui.define([
	...
	return Opa5.extend("com.chappota.billingdocument.billongdocument.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.chappota.billingdocument.billongdocument",
					async: true
				},
				hash: oOptions.hash,
