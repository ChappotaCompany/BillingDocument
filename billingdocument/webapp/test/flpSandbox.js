		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comchappotabillingdocumentbillongdocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotabillingdocumentbillongdocument-display": {
								"semanticObject": "comchappotabillingdocumentbillongdocument",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.billingdocument.billongdocument",
									"url": sap.ui.require.toUrl("com/chappota/billingdocument/billongdocument")
								}
							}
						}
					}
